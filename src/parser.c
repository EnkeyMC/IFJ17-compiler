...
static bool add_built_ins(HashTable* htab) {
	...
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "wrongindex"), addr_symbol(F_LOCAL, "if2cond"), addr_constant(MAKE_TOKEN_BOOL(true)), false);
	IL_ADD(OP_STRI2INT, addr_symbol(F_LOCAL, "retval"), addr_symbol(F_LOCAL, "str"), addr_symbol(F_LOCAL, "i"), false);
	IL_ADD(OP_JUMP, addr_symbol("", "ascvalue"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LABEL, addr_symbol("", "wrongindex"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_MOVE, addr_symbol(F_LOCAL, "retval"), addr_constant(MAKE_TOKEN_INT(0)), NO_ADDR, false);
	IL_ADD(OP_LABEL, addr_symbol("", "ascvalue"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_POPFRAME, NO_ADDR, NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_RETURN, NO_ADDR, NO_ADDR, NO_ADDR, false);

	// SUBSTR function
	IL_ADD(OP_LABEL, addr_symbol("", "substr"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_PUSHFRAME, NO_ADDR, NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "substr"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "anotherchar"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "counter"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "total"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "retval"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_STRLEN, addr_symbol(F_LOCAL, "total"), addr_symbol(F_LOCAL, "str"), NO_ADDR, false);
	IL_ADD(OP_MOVE, addr_symbol(F_LOCAL, "substr"), addr_constant(MAKE_TOKEN_STRING("")), NO_ADDR, false);
	IL_ADD(OP_MOVE, addr_symbol(F_LOCAL, "counter"), addr_constant(MAKE_TOKEN_INT(0)), NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "if1cond"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LT, addr_symbol(F_LOCAL, "if1cond"), addr_symbol(F_LOCAL, "i"), addr_constant(MAKE_TOKEN_INT(1)), false);
	IL_ADD(OP_SUB, addr_symbol(F_LOCAL, "i"), addr_symbol(F_LOCAL, "i"), addr_constant(MAKE_TOKEN_INT(1)), false);
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "finalstring"), addr_symbol(F_LOCAL, "if1cond"), addr_constant(MAKE_TOKEN_BOOL(true)), false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "if2cond"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LT, addr_symbol(F_LOCAL, "if2cond"), addr_symbol(F_LOCAL, "n"), addr_constant(MAKE_TOKEN_INT(0)), false);
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "itoend"), addr_symbol(F_LOCAL, "if2cond"), addr_constant(MAKE_TOKEN_BOOL(true)), false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "if3cond"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_SUB, addr_symbol(F_LOCAL, "total"), addr_symbol(F_LOCAL, "total"), addr_symbol(F_LOCAL, "i"), false);
	IL_ADD(OP_GT, addr_symbol(F_LOCAL, "if3cond"), addr_symbol(F_LOCAL, "n"), addr_symbol(F_LOCAL, "total"), false);
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "itoend"), addr_symbol(F_LOCAL, "if3cond"), addr_constant(MAKE_TOKEN_BOOL(true)), false);
	IL_ADD(OP_LABEL, addr_symbol("", "charloop"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "finalstring"), addr_symbol(F_LOCAL, "counter"), addr_symbol(F_LOCAL, "n"), false);
	IL_ADD(OP_GETCHAR, addr_symbol(F_LOCAL, "anotherchar"), addr_symbol(F_LOCAL, "str"), addr_symbol(F_LOCAL, "i"), false);
	IL_ADD(OP_CONCAT, addr_symbol(F_LOCAL, "substr"), addr_symbol(F_LOCAL, "substr"), addr_symbol(F_LOCAL, "anotherchar"), false);
	IL_ADD(OP_ADD, addr_symbol(F_LOCAL, "i"), addr_symbol(F_LOCAL, "i"), addr_constant(MAKE_TOKEN_INT(1)), false);
	IL_ADD(OP_ADD, addr_symbol(F_LOCAL, "counter"), addr_symbol(F_LOCAL, "counter"), addr_constant(MAKE_TOKEN_INT(1)), false);
	IL_ADD(OP_JUMP, addr_symbol("", "charloop"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LABEL, addr_symbol("", "itoend"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_STRLEN, addr_symbol(F_LOCAL, "total"), addr_symbol(F_LOCAL, "str"), NO_ADDR, false);
	IL_ADD(OP_DEFVAR, addr_symbol(F_LOCAL, "itoendwhilecond"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LABEL, addr_symbol("", "itoendwhilecond"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LT, addr_symbol(F_LOCAL, "itoendwhilecond"), addr_symbol(F_LOCAL, "i"), addr_symbol(F_LOCAL, "total"), false);
	IL_ADD(OP_JUMPIFEQ, addr_symbol("", "finalstring"), addr_symbol(F_LOCAL, "itoendwhilecond"), addr_constant(MAKE_TOKEN_BOOL(false)), false);
	IL_ADD(OP_GETCHAR, addr_symbol(F_LOCAL, "anotherchar"), addr_symbol(F_LOCAL, "str"), addr_symbol(F_LOCAL, "i"), false);
	IL_ADD(OP_CONCAT, addr_symbol(F_LOCAL, "substr"), addr_symbol(F_LOCAL, "substr"), addr_symbol(F_LOCAL, "anotherchar"), false);
	IL_ADD(OP_ADD, addr_symbol(F_LOCAL, "i"), addr_symbol(F_LOCAL, "i"), addr_constant(MAKE_TOKEN_INT(1)), false);
	IL_ADD(OP_JUMP, addr_symbol("", "itoendwhile"), NO_ADDR, NO_ADDR, false);
	IL_ADD(OP_LABEL, addr_symbol("", "finalstring"), NO_ADDR, NO_ADDR, false);
