...
bool grammar_init() {
	...
	// STATEMENT
	TABLE_SET(NT_STATEMENT, TOKEN_KW_DECLARE, 4);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_DIM, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_DO, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_FUNCTION, 5);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_IF, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_INPUT, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_PRINT, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_SCOPE, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_FOR, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_KW_STATIC, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_IDENTIFIER, 3);
	TABLE_SET(NT_STATEMENT, TOKEN_EOL, 3);
	// INNER_STMT
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_DIM, 6);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_DO, 10);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_IF, 8);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_INPUT, 13);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_PRINT, 12);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_SCOPE, 9);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_FOR, 11);
	TABLE_SET(NT_INNER_STMT, TOKEN_KW_STATIC, 6);
	TABLE_SET(NT_INNER_STMT, TOKEN_IDENTIFIER, 7);
	TABLE_SET(NT_INNER_STMT, TOKEN_EOL, 14);
	// STMT_SEQ
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_DIM, 15);
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_DO, 15);
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_ELSE, 16);
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_END, 16);
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_AND, 16);
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_IF, 15);
	...
	TABLE_SET(NT_STMT_SEQ, TOKEN_KW_STATIC, 15);
	TABLE_SET(NT_STMT_SEQ, TOKEN_IDENTIFIER, 15);
	TABLE_SET(NT_STMT_SEQ, TOKEN_EOL, 15);
	// VAR_DECL
	TABLE_SET(NT_VAR_DECL, TOKEN_KW_DIM, 17);
	TABLE_SET(NT_VAR_DECL, TOKEN_KW_STATIC, 18);
	// VAR_DECL_NEXT
	TABLE_SET(NT_VAR_DECL_NEXT, TOKEN_KW_SHARED, 20);
	TABLE_SET(NT_VAR_DECL_NEXT, TOKEN_IDENTIFIER, 19);
	// VAR_DEF
	TABLE_SET(NT_VAR_DEF, TOKEN_IDENTIFIER, 21);
	// INIT_OPT
	TABLE_SET(NT_INIT_OPT, TOKEN_EOL, 23);
	TABLE_SET(NT_INIT_OPT, TOKEN_EQUAL, 22);
	// FUNC_DECL
	TABLE_SET(NT_FUNC_DECL, TOKEN_KW_DECLARE, 24);
	// TYPE
	TABLE_SET(NT_TYPE, TOKEN_KW_DOUBLE, 26);
	TABLE_SET(NT_TYPE, TOKEN_KW_INTEGER, 25);
	TABLE_SET(NT_TYPE, TOKEN_KW_STRING, 27);
	TABLE_SET(NT_TYPE, TOKEN_KW_BOOLEAN, 28);
	// FUNC_DEF
	TABLE_SET(NT_FUNC_DEF, TOKEN_KW_FUNCTION, 29);
	// FUNC_BODY
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_DIM, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_DO, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_AND, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_IF, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_INPUT, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_PRINT, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_RETURN, 31);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_SCOPE, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_FOR, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_KW_STATIC, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_IDENTIFIER, 30);
	TABLE_SET(NT_FUNC_BODY, TOKEN_EOL, 30);
	// PARAM_DECL
	TABLE_SET(NT_PARAM_DECL, TOKEN_IDENTIFIER, 32);
	// PARAMS
	TABLE_SET(NT_PARAMS, TOKEN_IDENTIFIER, 33);
	TABLE_SET(NT_PARAMS, TOKEN_RPAR, 34);
	// PARAMS_NEXT
	TABLE_SET(NT_PARAMS_NEXT, TOKEN_COMMA, 35);
	TABLE_SET(NT_PARAMS_NEXT, TOKEN_RPAR, 36);
	// ASSIGNMENT
	TABLE_SET(NT_ASSIGNMENT, TOKEN_IDENTIFIER, 37);
	// INPUT_STMT
	TABLE_SET(NT_INPUT_STMT, TOKEN_KW_INPUT, 38);
	// PRINT_STMT
	TABLE_SET(NT_PRINT_STMT, TOKEN_KW_PRINT, 39);
	// EXPRESSION_LIST
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_KW_FALSE, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_KW_TRUE, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_STRING, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_INT, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_REAL, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_IDENTIFIER, 40);
	TABLE_SET(NT_EXPRESSION_LIST, TOKEN_EOL, 41);
	// SCOPE_STMT
	TABLE_SET(NT_SCOPE_STMT, TOKEN_KW_SCOPE, 42);
	// IF_STMT
	TABLE_SET(NT_IF_STMT, TOKEN_KW_IF, 43);
	// IF_STMT_CONT
	TABLE_SET(NT_IF_STMT_CONT, TOKEN_KW_ELSE, 45);
	TABLE_SET(NT_IF_STMT_CONT, TOKEN_KW_AND, 44);
	TABLE_SET(NT_IF_STMT_CONT, TOKEN_KW_ELSEIF, 46);
	// IF_STMT_END
	TABLE_SET(NT_IF_STMT_END, TOKEN_KW_ELSE, 48);
	TABLE_SET(NT_IF_STMT_END, TOKEN_KW_END, 47);
	// DO_STMT
	TABLE_SET(NT_DO_STMT, TOKEN_KW_DO, 49);
	// DO_STMT_END
	TABLE_SET(NT_DO_STMT_END, TOKEN_KW_WHILE, 50);
	TABLE_SET(NT_DO_STMT_END, TOKEN_KW_UNTIL, 50);
	TABLE_SET(NT_DO_STMT_END, TOKEN_EOL, 51);
	// TEST_TYPE
	TABLE_SET(NT_TEST_TYPE, TOKEN_KW_WHILE, 52);
	TABLE_SET(NT_TEST_TYPE, TOKEN_KW_UNTIL, 53);
	// DO_BODY
	TABLE_SET(NT_DO_BODY, TOKEN_KW_DIM, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_DO, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_IF, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_INPUT, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_LOOP, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_PRINT, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_SCOPE, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_CONTINUE, 56);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_EXIT, 55);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_FOR, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_KW_STATIC, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_IDENTIFIER, 54);
	TABLE_SET(NT_DO_BODY, TOKEN_EOL, 54);
	// FOR_STMT
	TABLE_SET(NT_FOR_STMT, TOKEN_KW_FOR, 57);
	// FOR_BODY
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_DIM, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_DO, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_IF, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_INPUT, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_PRINT, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_SCOPE, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_CONTINUE, 60);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_EXIT, 59);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_FOR, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_NEXT, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_KW_STATIC, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_IDENTIFIER, 58);
	TABLE_SET(NT_FOR_BODY, TOKEN_EOL, 58);
	// TYPE_OPT
	TABLE_SET(NT_TYPE_OPT, TOKEN_KW_AS, 61);
	TABLE_SET(NT_TYPE_OPT, TOKEN_EQUAL, 62);
	// STEP_OPT
	TABLE_SET(NT_STEP_OPT, TOKEN_KW_STEP, 63);
	TABLE_SET(NT_STEP_OPT, TOKEN_EOL, 64);
	// ID_OPT
	TABLE_SET(NT_ID_OPT, TOKEN_IDENTIFIER, 65);
	TABLE_SET(NT_ID_OPT, TOKEN_EOL, 66);
	// ASSIGN_OPERATOR
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_EQUAL, 67);
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_SUB_ASIGN, 68);
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_ADD_ASIGN, 69);
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_MUL_ASIGN, 70);
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_DIVI_ASIGN, 71);
	TABLE_SET(NT_ASSIGN_OPERATOR, TOKEN_DIVR_ASIGN, 72);
	// EXPRESSION
	TABLE_SET(NT_EXPRESSION, TOKEN_KW_FALSE, 78);
	TABLE_SET(NT_EXPRESSION, TOKEN_KW_TRUE, 77);
	TABLE_SET(NT_EXPRESSION, TOKEN_STRING, 76);
	TABLE_SET(NT_EXPRESSION, TOKEN_INT, 74);
	TABLE_SET(NT_EXPRESSION, TOKEN_REAL, 75);
	TABLE_SET(NT_EXPRESSION, TOKEN_IDENTIFIER, 73);
