...
bool grammar_init() {
	...
	ADD_RULE(NT_LINE, NT_STATEMENT, TOKEN_EOL);
	ADD_RULE(NT_STATEMENT, NT_VAR_DECL);
	ADD_RULE(NT_STATEMENT, NT_FUNC_DECL);
	ADD_RULE(NT_STATEMENT, NT_FUNC_DEF);
	ADD_RULE(NT_STATEMENT, NT_ASSIGNMENT);
	ADD_RULE(NT_STATEMENT, NT_IF_STMT);
	ADD_RULE(NT_STATEMENT, NT_SCOPE_STMT);
	ADD_RULE(NT_STATEMENT, NT_DO_STMT);
	ADD_RULE(NT_STATEMENT, NT_FOR_STMT);
	ADD_RULE(NT_STATEMENT, NT_PRINT_STMT);
	ADD_RULE(NT_STATEMENT, NT_INPUT_STMT);
	ADD_EPSILON_RULE(NT_STATEMENT);
	...
	ADD_RULE(NT_DO_STMT, TOKEN_KW_DO, TOKEN_EOL, NT_DO_BODY, TOKEN_KW_LOOP, NT_TEST_TYPE, NT_EXPRESSION);
