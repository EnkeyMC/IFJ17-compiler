...
bool expr_grammar_init() {
	...
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_RPAR, TOKEN_LPAR, TOKEN_IDENTIFIER);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_RPAR, NT_EXPRESSION, TOKEN_LPAR, TOKEN_IDENTIFIER);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_RPAR, NT_LIST, TOKEN_LPAR, TOKEN_IDENTIFIER);
	ADD_EXPR_RULE(NT_LIST, NULL, NT_EXPRESSION, TOKEN_COMMA, NT_LIST);
	ADD_EXPR_RULE(NT_LIST, NULL, NT_EXPRESSION, TOKEN_COMMA, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_IDENTIFIER);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_STRING);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_INT);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_REAL);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_KW_TRUE);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_KW_FALSE);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, TOKEN_RPAR, NT_EXPRESSION, TOKEN_LPAR);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_SUB);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_ADD, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_SUB, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_MUL, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_DIVI, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_DIVR, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_EQUAL, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_NE, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_GT, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_GE, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_LT, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_LE, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_KW_NOT);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_KW_AND, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, NULL, NT_EXPRESSION, TOKEN_KW_OR, NT_EXPRESSION);
