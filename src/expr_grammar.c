...
bool expr_grammar_init() {
	...
	ADD_EXPR_RULE(NT_EXPRESSION, sem_expr_and_or, NT_EXPRESSION, TOKEN_KW_AND, NT_EXPRESSION);
	ADD_EXPR_RULE(NT_EXPRESSION, sem_expr_and_or, NT_EXPRESSION, TOKEN_KW_OR, NT_EXPRESSION);
